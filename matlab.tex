...
\end{lstlisting}
	...
	\subsection{Workspace}
		...
		\begin{figure}
			\center
			\begin{tikzpicture}
				\node at (0,0) {\includegraphics[width=0.95\linewidth]{./fig/workspace_zoom.PNG}};
				\draw[very thick,red,->] (2,0) -- (3.5,2.5);
			\end{tikzpicture}
			\caption{
				The workspace in \matlab. You can see here the variables \mcode{ans, str\_1, str\_2} and \mcode{x} as well as their contents.
			}
			\label{fig-workspace}
		\end{figure}	
	%%
...
\section{A beautiful plot}
	...
	\begin{figure}
		\center
		\fbox{\includegraphics[width=0.95\linewidth]{./fig/beautiful_plot.png}}
		\caption{
...
\end{lstlisting}
		\begin{figure}
			\center
			\subfigure[]{\includegraphics[height=0.43\linewidth]{./fig/plot_label.PNG}\label{subfig-label1}} 
			\subfigure[]{\includegraphics[height=0.43\linewidth]{./fig/cosx.PNG}\label{subfig-label2}}
			\caption{
...
\end{lstlisting}
		...
		\begin{figure}
			\center
			\subfigure[]{\includegraphics[height=0.43\linewidth]{./fig/multi_plot1.PNG}\label{subfig-multi1}} 
			\subfigure[]{\includegraphics[height=0.43\linewidth]{./fig/multi_plot_style.PNG}\label{subfig-multi2}}
			\caption{
