...
It should not be mixed with numbers.
}
...
\defbox{Prompt}{The prompt is the $>>$ sign. 

Once enter is hit, \matlab will interpret the line, and send back any results.
}
...
Nevertheless, it makes sense when assigning a few variables that are related.
}
